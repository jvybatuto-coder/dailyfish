...
5. Configure:
   - Build Command: `cd myproject && pip install -r requirements.txt && python manage.py migrate && python manage.py createsuperuser --username admin --noinput --email admin@dailyfish.com || echo "Admin may already exist"`
